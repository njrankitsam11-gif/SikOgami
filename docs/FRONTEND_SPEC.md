...
## app.js (1220 lines)
- LEVELS 30 objects — deepened, shape-accurate multi-step sequences with svgType, SVG generator getStepSvg() (id,world,title,emoji,color,sheets,diff,unlocks,paperTip,steps). W1 1-6 single (boat 12 steps, others 8), W2 7-12 single (butterfly/frog 10, crane 12, fox/fish/penguin 8), W3 13-18 2 papers, W4 19-24 modular, W5 25-30 master 12 max.
