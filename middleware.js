export default async function middleware(request) {
  ...
  if (isMarkdown) {
    ...
    let mdPath = '/llms.txt';
    if (url.pathname === '/about' || url.pathname === '/about.html') mdPath = '/about.md';
    ...
    else if (url.pathname === '/' || url.pathname === '/index.html') mdPath = '/llms.txt';
    ...
    if (url.pathname !== '/' && url.pathname !== '/llms.txt' && url.pathname !== '/sitemap.xml' && url.pathname !== '/robots.txt' && url.pathname !== '/openapi.json' && !url.pathname.startsWith('/api/') && !url.pathname.startsWith('/.well-known/')) {
